...
def run(
        ...
        weights='/Users/caesaryang/Developer/1-Graduate/res_analysis/res_bifpn_tph_slim_full/weights/best.pt',
        # file/dir/URL/glob/screen/0(webcam)
        source='/Users/caesaryang/Downloads/test',
        data='data/helmet1_local.yaml',  # dataset.yaml path
        ...
        name='exp_test',  # save results to project/name
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default='/Users/caesaryang/Downloads/matdisk/avg_ckpt_E1.pt', help='model path or triton URL')
    parser.add_argument('--source', type=str, default=ROOT /
                        '/Users/caesaryang/Developer/1-Graduate/datasets/helmet_test2_car_factory/images', help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default=ROOT /
                        'data/helmet1_local.yaml', help='(optional) dataset.yaml path')
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+',
                        type=int, default=[300], help='inference size h,w')
