...
# sys.path.append('/Users/caesaryang/Developer/1-Graduate/YOLOv5_HNet/utils')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str,
                        default='/Users/caesaryang/Developer/1-Graduate/YOLOv5_HNet/models/modify_yolov5xs_C3.yaml', help='model.yaml')
    ...
    script_model.save('modify_yolov5xs_C3.pt')
