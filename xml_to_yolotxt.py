...
dataset_path = '/Users/caesaryang/Developer/1-Graduate/datasets/helmet_test1'
...
for image_set in sets:
    ...
    image_ids = open(os.path.join(dataset_path, 'ImageSets/Main/%s.txt' %
