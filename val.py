...
def parse_opt():
    ...
    parser.add_argument(
        '--data', type=str, default='/Users/caesaryang/Developer/1-Graduate/YOLOv5_HNet/data/helmet2_local.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str,
                        default='/Users/caesaryang/Developer/1-Graduate/res_analysis/2-车厂/exp10_spd3/weights/best.pt', help='model path(s)')
    parser.add_argument('--batch-size', type=int,
                        default=32, help='batch size')
    parser.add_argument('--imgsz', '--img', '--img-size',
                        type=int, default=320, help='inference size (pixels)')
