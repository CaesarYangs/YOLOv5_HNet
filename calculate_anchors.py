...
FILE_ROOT = "/Users/caesaryang/Developer/1-Graduate/datasets/helmet_test1"     # 根路径
...
if __name__ == '__main__':
    ...
    for i in range(10):  # 可以修改，不要太大，否则时间很长
        ...
        for j in range(CLUSTERS):
            anchor = [round(clusters[j][0] * 640, 2),
    ...
    anchors_txt.write("Best Accuracy = " +
                      str(round(best_accuracy, 2)) + '%' + "\r\n")
